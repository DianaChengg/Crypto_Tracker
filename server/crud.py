...
# def add_or_update_portfolio(portfolio: schemas.PortfolioCreate, db: Session = Depends(get_db)):
#     """
#     Add or update a cryptocurrency in the user's portfolio.
#     """
#     try:
#         return create_portfolio_entry(db=db, portfolio=portfolio)
...
# def get_price_by_cid(db: Session, cid: str):
#     price_entry = db.query(models.Price).filter(models.Price.cid == cid).first()
#     if price_entry:
#         return float(price_entry.current_price)  # Ensure numeric value
#     return 0.0
